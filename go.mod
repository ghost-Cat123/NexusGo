...
replace GrowRPC => ./apps/pkg/GrowRPC

require (
	GrowRPC v0.0.0-00010101000000-000000000000
...
replace (
	go.etcd.io/etcd/pkg/v3 => go.etcd.io/etcd/pkg/v3 v3.6.12
	go.etcd.io/etcd/server/v3 => go.etcd.io/etcd/server/v3 v3.6.12
)
